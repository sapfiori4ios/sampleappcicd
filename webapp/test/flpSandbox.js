		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Sample App",
									"targetURL": "#comsamplesampleapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsamplesampleapp-display": {
								"semanticObject": "comsamplesampleapp",
								"action": "display",
								"description": "Sample Fiori app",
								"title": "Sample App",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sample.sampleapp",
									"url": sap.ui.require.toUrl("com/sample/sampleapp")
								}
							}
						}
					}
